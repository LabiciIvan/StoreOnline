<div class=" d-flex flex-row justify-content-center border bg-light shadow w-100">
  ...
  <div class="d-flex flex-row justify-content-center w-75 m-2">
    <div class="m-2">
      <a class="nav-link text-dark fw-bold" href="{{ route('user.index') }}">Home</a></div>
    <div class="m-2">
      <a class="nav-link text-dark fw-bold" href="{{ route('user.contact') }}">Contact</a></div>
    <div class="m-2">
      <a class="nav-link text-dark fw-bold" href="{{ route('user.viewCart') }}">Cart</a></div>
  </div>

    <div class="d-flex flex-row-reverse w-25 m-2">
      @guest
      <div class="m-2 ">
        <a class="nav-link text-dark text-muted" href="{{ route('login') }}">Log-In</a></div>
        <div class="m-2">
          <a class="nav-link text-dark text-muted" href="{{ route('register') }}">Register</a></div>
